...
function ToggleTheme() {
  ...
  return (
    <div className="flex items-center justify-center w-full gap-2 md:gap-4 before:block before:h-6 before:w-0.5 dark:before:bg-white before:bg-black before:rounded-lg">
      <svg width="19" height="19" xmlns="http://www.w3.org/2000/svg" className="dark:fill-white fill-black">
      ...
      >
        ...
        <div className={`absolute cursor-pointer bottom-0 left-0 top-0 right-0 dark:bg-white bg-black rounded-full lg:hover:bg-blue-600 transition-all duration-300 ease-in-out before:absolute before:h-4 before:w-4 before:bg-white dark:before:bg-black before:top-1 before:left-1 before:rounded-full ${theme === 'dark' ? 'before:translate-x-6' : 'before:translate-x-0'} before:transition-all before:duration-300 before:ease-in-out`} />
      </label>

      <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" className="dark:fill-white fill-black">
